...
import KwikswapV2ERC20 from '@kwikswap/v2-core/build/ERC20.json'
...
export async function stakingRewardsFixture([wallet]: Wallet[]): Promise<StakingRewardsFixture> {
  ...
  const stakingToken = await deployContract(wallet, KwikswapV2ERC20, [expandTo18Decimals(1000000)])
